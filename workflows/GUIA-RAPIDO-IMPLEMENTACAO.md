...
5. **Options** → Response:
   ...
   - **Response Format: `Autodetect`** ⚠️ IMPORTANTE: Deixar autodetect (não JSON)
...
**Solução:** 
- Options → Response → **Response Format: `Autodetect`** (não forçar JSON)
- ✅ Corrigido no guia - Autodetect é melhor que Text pois é mais flexível
