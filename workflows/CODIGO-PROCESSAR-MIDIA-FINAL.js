// ============================================================================
// 🎬 PROCESSAR MÍDIA DO USUÁRIO - VERSÃO FINAL TESTADA
// ============================================================================
...
for (const item of items) {
  ...
  for (const attachment of attachments) {
    ...
    // ==========================================
    else if (fileType === 'audio' || dataUrl.match(/\.(ogg|mp3|m4a|wav)$/i)) {
    ...
    // ==========================================
      ...
      try {
        if (dataUrl.match(/\.txt$/i)) {
          ...
          mediaContent += `\n\n[DOCUMENTO RECEBIDO]\nNome: ${fileName}\n`;
          mediaContent += 'Documento recebido. Para análise detalhada, descreva o que você precisa saber.\n';
          mediaType = 'document';
          mediaProcessed = true;
    ...
    // ==========================================
      ...
      mediaContent += `\n\n[VÍDEO RECEBIDO]\nNome: ${fileName}\n`;
      mediaContent += 'Vídeo recebido. Para análise, descreva o que você precisa saber.\n';
      mediaType = 'video';
      mediaProcessed = true;
    ...
    // ==========================================
      ...
      console.log('⚠️ Formato não reconhecido:', fileType);
...
console.log(`✅ Processamento completo: ${processedItems.length} items`);
